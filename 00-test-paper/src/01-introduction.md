...
This is a test paper—its job is to exercise the pipeline, not to make a substantive claim. The Lyapunov-LMI framework[^lmi] established by \citet{boyd-ghaoui-feron-balakrishnan-1994-lmi} anchors much of the formal-methods community; \citet{anderson-1985-bursting} gave the canonical statement of bursting (i.e., transient instability under reduced persistent excitation). The latter is invoked widely as a foundational result in adaptive control textbooks \cite{anderson-1985-bursting}, alongside cellular-neuroscience work \cite{hasselmo-schnell-barkai-1995-dynamics}. Multi-cite renders compactly via natbib's `sort&compress`: \cite{anderson-1985-bursting,boyd-ghaoui-feron-balakrishnan-1994-lmi,hasselmo-schnell-barkai-1995-dynamics}. Cite postnote with raw-LaTeX special chars passes through cleanly: \cite[ch.~4 \& 9]{boyd-ghaoui-feron-balakrishnan-1994-lmi}.
